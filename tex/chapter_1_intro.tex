...
% Chapter 1 of the MSE 142 coursereader. 
% This chapter is meant to give an overview of the intellectual history of quantum mechanics and build intuition through various experiments such as double-slit, photoelectric effect, Davisson-Germer, Stern-Gerlach, and the quantum eraser. 
% It also introduces wave-particle duality and superposition.
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.27\linewidth]{xkcd-quantum.png} \label{fig:xkcd1} 
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.5\linewidth]{SG-app.pdf}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.5\linewidth]{SG-full.pdf}
...
But this is not the end of the surprises. 
...
The above results should seem quite unusual. 
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.6\linewidth]{polarizer.pdf}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.5\linewidth]{double-slit.pdf}
	\put(-100, -5) {single}
...
Then, in 1803, Thomas Young's discovery of double-slit interference only seemed to further validate the wave theory and dispel other explanations.\footnote{T. Young, \href{https://royalsocietypublishing.org/doi/abs/10.1098/rstl.1804.0001}{\emph{Phil. Trans. R. Soc.}} 94, 1803.}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.5\linewidth]{photoelectric-effect.pdf}
...
In his thesis, de Broglie extended this definition, along with \autoref{eq:EdB} and \ref{eq:pdB}, to describe \emph{all} types of matter. 
...
\begin{figure}[!h]
	\centering
	\subfloat[]{\includegraphics[width=0.5\linewidth]{davisson-germer.pdf} \label{fig:DG-exp}}
	\subfloat[]{\includegraphics[width=0.5\linewidth]{DG-plot.png} \label{fig:DG-plot}}
	\caption{\protect\subref{fig:DG-exp} Schematic of the Davisson-Germer experiment. 
	...
	\protect\subref{fig:DG-plot} The spectra contains sharp peaks of intensity at distinct diffraction angles. 
...
Although some of these experiments are over a century old, they established the fundamental basis for more advanced theories and experiments that are still being investigated today. 
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.6\linewidth]{quantum-eraser.pdf}
...
But what would happen if we first marked the slits, and then ``erased" the markings? 
